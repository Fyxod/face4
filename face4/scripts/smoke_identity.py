...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="FACE edited-output ArcFace identity smoke.")
    ...
    parser.add_argument("--output-root", default="outputs/smoke_dct_image_pipeline")
...
def main() -> None:
    ...
    print(f"[face4-smoke] wrote: {summary['output_root']}")
